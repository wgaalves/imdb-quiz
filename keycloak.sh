...
docker exec -it keycloak /opt/jboss/keycloak/bin/kcadm.sh create clients -r master -s clientId=spring-with-test-scope -s enabled=true -s clientAuthenticatorType=client-secret -s secret=b129f0c2-a46a-4bdb-a059-4eca03639767 -s ‘redirectUris=[“*”]’ -s ‘defaultClientScopes=[“QUIZ_PLAY_ROLE”, “web-origins”, “profile”, “roles”, “email”]’
